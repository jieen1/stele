...
| **J-02** observation-hook.js had a 4th divergent DEFAULT_PROTECTED list | Unified to the canonical 24-entry set, added as a 4th source to `default_protected_consistent` checker. |
